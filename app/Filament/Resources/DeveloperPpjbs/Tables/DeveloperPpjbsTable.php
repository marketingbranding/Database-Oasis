...
class DeveloperPpjbsTable
{
    public static function configure(Table $table): Table
    {
        return $table->columns([
            ...
            TextColumn::make('salesCase.financing_type')->label('Financing')->badge(), TextColumn::make('ppjb_identifier')->label('PPJB')->state(fn (DeveloperPpjb $record): string => $record->displayPpjbIdentifier())->searchable(['ppjb_code', 'document_number']),
